    ...
    public function checkTempalateRule($isProduct, $isCategory, $isFilter, $info = false)
    {
       ...
       if ($isProduct) {
        ...
        if ($seoTemplateRule) {
            ...
            $seoTemplateRule->setMetaTitle(Mage::helper('seo/parse')->parse($seoTemplateRule->getMetaTitle(), $this->_parseObjects, $this->_additional, $this->_storeId));
            $seoTemplateRule->setMetaKeywords(Mage::helper('seo/parse')->parse($seoTemplateRule->getMetaKeywords(), $this->_parseObjects, $this->_additional, $this->_storeId));
            $seoTemplateRule->setMetaDescription(Mage::helper('seo/parse')->parse($seoTemplateRule->getMetaDescription(), $this->_parseObjects, $this->_additional, $this->_storeId));
