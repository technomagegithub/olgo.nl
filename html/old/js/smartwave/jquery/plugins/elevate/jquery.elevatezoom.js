			...
			startZoom: function( ) {
				...
				if(self.options.imageCrossfade){
                    if (self.$elem.parent().hasClass('zoomWrapper')) {
                        self.zoomWrap = self.$elem.parent();
                        self.zoomWrap.css('height', self.nzHeight);
                        self.zoomWrap.css('width', self.nzWidth);
                    } else {
                        self.zoomWrap = self.$elem.wrap('<div style="height:'+self.nzHeight+'px;width:'+self.nzWidth+'px;border:solid '+self.options.imgBorderSize+'px '+self.options.imgBorderColour+'" class="zoomWrapper" />');           
                    }
...
//						and on mouseleave check if scrolllock          
        ...
        if(!self.options.zoomEnabled){return false;}
			...
			setWindowPostition: function( e ) {
				...
				self.windowOffsetTop = self.windowOffsetTop + self.options.zoomWindowOffety - self.options.imgBorderSize;
...
//					calculate new width ratio
	...
	$.fn.elevateZoom.options = {
            ...
            imgBorderSize: 0,   //smartwave customization. Main Imnage Border Width
            imgBorderColour: "#000",    //smartwave customization. Main Image Border Color
