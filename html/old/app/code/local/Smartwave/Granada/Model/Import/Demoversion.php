...
class Smartwave_Granada_Model_Import_Demoversion extends Mage_Core_Model_Abstract
{
	private $_importPath;
	...
	public function importDemoversion($demoversion,$store=NULL,$website = NULL)
    {
		try
		{
			...
			{
				throw new Exception(
					Mage::helper('granada')->__("Can't get the data file for import demoversion: %s", $xmlPath)
                );
			}
