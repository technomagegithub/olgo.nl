...
class Smartwave_Granada_Helper_Richsnippets extends Mage_Core_Helper_Abstract
{
	...
	public function isEnabled() {
		return Mage::getStoreConfig('granada_setting/richsnippets/enable');
	}
	...
	public function getPriceProperties($product) {
		...
		$includeTax = Mage::getStoreConfig('granada_setting/richsnippets/price_incl_tax');
