 ...
 * @author om
 */
class Smartwave_Filterproducts_Block_Featured_List extends Mage_Catalog_Block_Product_List
{
    ...
    public function getTitle() {
        ...
        $code  = $store->getCode();
        $title = Mage::getStoreConfig('filterproducts/config2/title',$code);
        if ($title) {
            return $title;
        } else {
            return $this->__('Featured Product');
        }
    }
