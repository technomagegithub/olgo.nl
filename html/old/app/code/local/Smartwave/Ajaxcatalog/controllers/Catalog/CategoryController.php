...
class Smartwave_Ajaxcatalog_Catalog_CategoryController extends Mage_Catalog_CategoryController
{
	...
	public function viewAction()
	{
		if($this->getRequest()->isXmlHttpRequest()){ //Check if it was an AJAX request
			...
			$viewpanel = $this->getLayout()->createBlock("catalog/layer_view","catalog.side.nav")->unsetChild("category_filter")->setTemplate("catalog/layer/view.phtml");
