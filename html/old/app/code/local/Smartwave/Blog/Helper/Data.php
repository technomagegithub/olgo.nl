...
class Smartwave_Blog_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    const XML_SIDE_BLOCK = 'blog/menu/sideblock';
    /* metadata */
    ...
    public function isEnableSideBlock($store = null)
    {
        return $this->conf(self::XML_SIDE_BLOCK, $store);
    }
    ...
    public function getRouteUrl($store = null)
    {
		...
		return Mage::getUrl($this->getRoute($store));
    }
    ...
    {
        return Mage::getStoreConfig('blog/blog/enabled') && $this->extensionEnabled('Smartwave_Blog');
    }
    ...
    /**
     * Check is Smartwave_Mobile installed
     *
     * @return bool
     */
    public function isMobileInstalled()
    {
        return $this->isModuleOutputEnabled('Smartwave_Mobile')
            && @class_exists('Smartwave_Mobile_Block_Catalog_Product_List_Toolbar')
        ;
    }
}