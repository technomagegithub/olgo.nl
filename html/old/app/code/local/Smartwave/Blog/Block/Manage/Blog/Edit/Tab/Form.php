...
class Smartwave_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            array(
                 ...
                 'class'              => 'required-entry smartwave-blog-validate-identifier',
                 'required'           => true,
                 'name'               => 'identifier',
                 'after_element_html' => '<span class="hint">' . $noticeMessage . '</span>'
                     . "<script>
                        Validation.add(
                            'smartwave-blog-validate-identifier',
		...
		$fieldset->addField('banner', 'image', array(
            'label'     => Mage::helper('blog')->__('Banner Image'),
            'required'  => false,
            'name'      => 'banner',
        ));
        ...
        $fieldset->addField(
            ...
            array(
                'name'   => 'banner_content',
                 'label'  => Mage::helper('blog')->__('Banner Content'),
                 'title'  => Mage::helper('blog')->__('Banner Content'),
