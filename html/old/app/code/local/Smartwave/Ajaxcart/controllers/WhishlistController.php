	...
	public function compareAction(){
		...
		if ($productId = (int) $this->getRequest()->getParam('product')) {
			...
			if ($product->getId()/* && !$product->isSuper()*/) {
                ...
                $this->loadLayout();
                $toolbar = $this->getLayout()->createBlock('catalog/product_compare_sidebar')->setTemplate('catalog/product/list/compare.phtml')->toHtml();
                $response['toolbar_compare'] = $toolbar;
			}
		}
